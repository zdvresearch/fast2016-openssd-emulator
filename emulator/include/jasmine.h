...
#define OPTION_NO_DRAM_ABSORB           1    // 1 = no DRAM absorb, 0 = enable DRAM absorb
...
//-------------------------------------------------------------
//#define NUM_LSECTORS        (NUM_PSECTORS)              // 2048 data blk per bank
//#define NUM_LSECTORS      (NUM_PSECTORS  / 2)         // 1024 data blk per bank
//#define NUM_LSECTORS      (NUM_PSECTORS  / 4)         // 512 data blk per bank
//#define NUM_LSECTORS      (NUM_PSECTORS  / 8)         // 256 data blk per bank
//#define NUM_LSECTORS      (NUM_PSECTORS  / 16)        // 128 data blk per bank
//#define NUM_LSECTORS      (NUM_PSECTORS  / 32)        // 64 data blk per bank
//#define NUM_LSECTORS      (NUM_PSECTORS  / 64)        // 32 data blk per bank
//#define NUM_LSECTORS      (NUM_PSECTORS  / 128)       // 16 data blk per bank
#define NUM_LSECTORS      (NUM_PSECTORS  / 256)       // 8 data blk per bank
//#define NUM_LSECTORS      (NUM_PSECTORS  / 512)       // 4 data blk per bank
//#define NUM_LSECTORS      (NUM_PSECTORS  / 1024)      // 2 data blk per bank
