...
#define mem_set_sram(ADDR, VAL, BYTES)                  _mem_set_sram((void *) (ADDR), (UINT32) (VAL), (UINT32) (BYTES))
...
#define mem_search_equ_4_bytes(ADDR, SIZE, CMD, VAL)      _mem_search_equ_4_bytes((UINT32) (ADDR),  (UINT32) (SIZE), (UINT32) (CMD), (UINT32) (VAL))
...
void _mem_set_sram(void * addr, UINT32 const val, UINT32 bytes);
void _mem_set_dram(UINT32 addr, UINT32 const val, UINT32 bytes);
void _mem_copy(void* dst, void* src, const UINT32 bytes);
